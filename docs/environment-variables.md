...
| NEXT_PUBLIC_NEKOCAP_API_URL              | string | Base URL of the NekoCap API server. The website and extension call its REST API under `/api/v1`                          | http://localhost:4041       |
| NEKOCAP_INTERNAL_API_URL                 | string | Optional. URL for the NextJS **server** (backend only) to reach the NekoCap API. Defaults to NEXT_PUBLIC_NEKOCAP_API_URL | http://localhost:4041       |
